...
export default class GanttChartResource extends LightningElement {
    ...
    setProjects() {
        ...
        Object.keys(self._resource.allocationsByProject).forEach(
            (projectId) => {
                let project = {
                    id: projectId,
                    allocations: []
    ...
    handleDragStart(event) {
        ...
        this.dragInfo.newAllocation =
            this.projects[container.dataset.project].allocations[
    ...
    handleDragEnter(event) {
        ...
        let allocation = JSON.parse(
            JSON.stringify(
                this.projects[projectIndex].allocations[allocationIndex]
            )
        );
    ...
    handleEditAllocationDataChange(event) {
        this.editAllocationData[event.target.dataset.field] =
            event.target.value;
